...
@account_presets.put("/{preset_id}", response_model=AccountStationPreset, response_model_exclude_none=True, responses={404: {"model": ErrorDetail}})
...
@account_presets.get("/{preset_id}", response_model=AccountStationPreset, response_model_exclude_none=True, responses={404: {"model": ErrorDetail}})
...
@global_presets.put("/{preset_id}", response_model=GlobalStationPreset, response_model_exclude_none=True, responses={404: {"model": ErrorDetail}})
...
@global_presets.get("/{preset_id}", response_model=GlobalStationPreset, response_model_exclude_none=True, responses={404: {"model": ErrorDetail}})
